<div class="w-2/12 px-5 min-h-screen bg-orange-500" id="sidebar">
  <div class="my-5 px-4">
  ...
  <div class="space-y-5">
    <div>
      ...
      <div class="space-y-4">
        <a href="#" class="rounded-sm bg-orange-400 px-5 py-2 text-white font-medium flex space-x-3 items-center">
          <div>
